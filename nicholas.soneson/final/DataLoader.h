...
public:
	...
	//Language Data
	string getLanguagePath() { return mLanguagePath; };
	string getEnglishLangFile() { return mEnglishFile; };
	string getSpanishoLangFile() { return mSpanishoFile; };
	string getTLangFile() { return mTLangFile; };

	//Audio Data
	string getAudioPath() { return mAudioPath; };
	string getShotSoundFile() { return mShotSoundFile; };

	//Level Data
	string getFirstLevel() { return mFirstLevel; };
...
private:
	...
	string mEnglishFile;
	string mSpanishoFile;
	string mTLangFile;

	//Audio Data
	string mAudioPath;
	string mShotSoundFile;
