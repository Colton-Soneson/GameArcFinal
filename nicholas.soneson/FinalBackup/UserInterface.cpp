...
void UserInterface::updateUI()
{
	...
	if (Game::getInstance()->getEnemyManager()->checkIfAllEnemiesKilled() == true && Game::getInstance()->getCurrentLevel()->getNextLevelPath() == "$ENDGAME$")
	{
		mEndState << Game::getInstance()->getLanguageSystem()->getWordAtKeysIndex(21);
	}
